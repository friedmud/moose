...
{
  std::vector<ExecFlagType> exec_types(12);
  ...
  exec_types[6] = EXEC_CYCLE_END;
  exec_types[7] = EXEC_CYCLE_BEGIN;
  exec_types[8] = EXEC_PICARD_END;
  exec_types[9] = EXEC_PICARD_BEGIN;
  exec_types[10] = EXEC_STAGE_END;
  exec_types[11] = EXEC_STAGE_BEGIN;
