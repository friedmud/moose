...
InputParameters validParams<MultiApp>()
{
  ...
  params.addParam<MultiMooseEnum>("execute_on", execute_options, "Set to (linear|nonlinear|timestep_end|timestep_begin|custom|cycle_begin|cycle_end|picard_begin|picard_end|stage_begin|stage_end) to execute only at that moment");
